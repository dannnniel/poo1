...
def catalogo(productos: Array[Producto]) {
	...
	do {
		...
		opcion match {
			case 1 => {
				productosAgregados = agregarProductos(productos, cantidadProductos)
...
def agregarProductos(productos: Array[Producto],cantidadProductos: Int) : Int = {
	var continuar = 'n'
...
def capturarDatosProducto(productos: Array[Producto],i: Int) {
...
def mostrarCatalogoProductos(productos: Array[Producto],i: Int) {
...
def nota(productos: Array[Producto],cantidadProductos: Int){
	var totalNota = 0.0
